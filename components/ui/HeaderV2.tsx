...
export default function AppHeaderV2({
  ...
  return (
    <div className={headerContainerStyles}>
      <header className="header-main items-center justify-center" role="banner">
        <nav className="header-nav">
          ...
          <div className="contact">
            Contact:{" "}
            <a href="mailto:support@samircodes.com">support@samircodes.com</a>
          </div>
      ...
      <div className="glass-header__filter">
        <svg>
          <filter id="glassHeaderFilter" primitiveUnits="objectBoundingBox">
            <feImage
              result="map"
              width="100%"
              height="100%"
