...
export function middleware(request: NextRequest) {
    ...
    if (request.nextUrl.pathname.startsWith('/api')) {
        ...
        // Add additional authorization logic here e.g, validate JWT tokens, check specific auth schemes, etc.
    }

    // Continue with the request for non-API routes or if auth is valid
