# Redpanda/Kafka Custom Analytics Pipeline Documentation
...
* **Client Analytics Hook**: [hooks/use-analytics.ts](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/hooks/use-analytics.ts)
...
* **Non-Link Click Tracking Hook**: [hooks/use-click-tracking.ts](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/hooks/use-click-tracking.ts)
  - Extends click tracking to non-anchor UI elements (buttons, modals, tabs).
* **Server-Side Edge Proxy**: [app/api/analytics/route.ts](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/app/api/analytics/route.ts)
...
* **Auto-Tracking Components**:
  - [PageViewTracker](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/features/analytics/components/page-view-tracker.tsx): Implicitly fires page views on Next.js App Router navigation hooks.
  - [TrackedLink](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/features/analytics/components/tracked-link.tsx): Reusable element that intercepts anchor tag clicks to log link analytics.
* **Unit Testing Suite**: [hooks/__tests__/use-analytics.test.ts](file:///Users/Apple/Developer/github.com/samirllama/samir.codes/hooks/__tests__/use-analytics.test.ts)
