...
description: "The `this` keyword in JavaScript is a source of endless confusion, a rite of passage for every new developer."
date: "2025-09-01"
...
introduce.call(person1, 30, "Engineer"); // Hi, I'm Bob, I'm 30 and I work as a Engineer.
introduce.apply(person2, [25, "Designer"]); // Hi, I'm Charlie, I'm 25 and I work as a Designer.
...
class Counter {
  ...
  handleClick() {
    this.count++; // TypeError: Cannot read properties of undefined (reading 'count')
...
- Use an **arrow function** for `helper`:
  ```javascript
  const helper = () => {
    return this.value + num; // 'this' correctly refers to 'calculator'
  };
  ```
...
increase(); // Problem: 'this' is window/global, score is NaN (or global.score)
