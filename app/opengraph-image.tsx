...
// Optional metadata exports picked up automatically:
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <h1 style={{ marginLeft: "20px", fontSize: "32px" }}>Samir Lama</h1>
        </div>
        ...
        >
          <h2
            style={{ fontSize: "64px", textAlign: "center", lineHeight: 1.1 }}
          >
            Welcome to My Blog
          </h2>
        </div>
