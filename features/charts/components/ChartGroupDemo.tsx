...
export function ChartGroupDemo() {
  const onGroupInit = (initResults: IInitResult[]) =>
    console.log("Group initialized", initResults);
  ...
  return (
    <div className="chart-demo">
      ...
      >
        <SciChartReact<
          SciChartSurface,
          TResolvedReturnType<typeof chartInitializationFunction>
        >
          ...
          onInit={(
            initResult: TResolvedReturnType<typeof chartInitializationFunction>
          ) => {
          ...
          onDelete={(
            ...
            console.log("Chart 1 onDelete", initResult);
          }}
        />
        <hr />
...
const chartInitializationFunction = async (
